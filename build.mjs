...
fs.writeFileSync('logic.mjs', logic + '\nexport { TYPES, CHART, POKEMON, norm, REG, POOL, checkRules, regulationStatus, effMultiplier, berryEffect, ABILITY_JA, ABILITY_FX, ITEMS, ITEM_BY, mulText, recommend, canHoldItem, defVector, threats, counterPlan, multiplier, analyze, summarize, suggest, typeKey, judge };\n');
